...
There is a core set of _Kubernetes_ processes that form the cluster runtime.  The cluster runtime is further divded into master components, aka the contole plane, and node components.  There is also a set of cluster add-ons.
